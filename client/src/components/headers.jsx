...
function Headers() {
  return (
    <div className="flex flex-row justify-around bg-[#F5EFE7] pt-3">
      <div className="p-3 mt-3 mb-1">
        <span className="text-[#F0BB78] bg-white text-4xl">find</span>
        <span className="text-[#3E5879] text-4xl">my</span>
        <span className="text-[#F0BB78] bg-white text-4xl">way</span>
      </div>
